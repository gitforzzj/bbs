      ...
      <center>
        <div style="margin-top:5%;">
            ...
            <span style="position:relative; left: -180px; top:40px;"><img src="<%=request.getContextPath()%>/images/right_big.gif" /></span> 
             <h3>修改成功！<span id="jumpTo" style="color:orange;">3</span>&nbsp;秒后自动跳转</h3> 
            <script type="text/javascript">countDown(3,'<%=request.getContextPath()%>/student!personalStuInfo.action');</script>  
