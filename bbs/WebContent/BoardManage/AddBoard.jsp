...
<html>
	...
	<center>
		<h1>添加版块</h1>
		<s:form action="board!addBoard.action" enctype="multipart/form-data">
			<ul>
				<li>上级版块:<select name="board.id">
						<option value="-1">无上级版块</option>
						<s:iterator value="boardList" id="row">
							<option value="<s:property value="#row.id" />"><s:property
				...
				<li><h2>版块图标上传</h2><s:file name="file" label="选择上传图片" /></li>
