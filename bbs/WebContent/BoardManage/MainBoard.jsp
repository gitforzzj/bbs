...
<html>
    ...
    <body>
    <center><h1><a href="<%=request.getContextPath() %>/board!prepareAddBoard.action">添加版块</a></h1></center>
      <div id="Lboard">
      ...
      <ul>   
          <li>
              ...
              <em> <font color="red"><a href="<%=request.getContextPath()%>/board!delBoard?boardId=<s:property value="#sub.id" />"><font color="red">删除</font></a></font></em>
              </a>
          </li>
     </s:iterator>
     </ul> 
