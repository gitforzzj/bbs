        ...
        <div style="margin-left:2%;">
            ...
            <div id="info">
                <table>
                	<tr>
                        <th>账号:</th>
                        <td><s:property value="admin.account" /></td>
                    </tr>
            ...
            <div id="modifyInfo">
               信息修改
               <s:form action="admin!modifyAdminInfo.action" >
                    <s:textfield id="nick" name="admin.nickName" value="%{admin.nickName}" label="昵称" required="true"></s:textfield><br/>
                    <s:textfield  name="admin.password" value="%{admin.password}" label="密码"></s:textfield><br/>
