...
<center>
        <div style="margin-top:5%;">
            ...
            <span style="position:relative; left: -180px; top:40px;"><img src="<%=request.getContextPath()%>/images/right_big.gif" /></span> 
             <h3>修改成功！<span id="jumpTo" style="color:orange;">3</span>&nbsp;秒后自动跳转到论坛首页</h3> 
            <script type="text/javascript">countDown(3,'admin!personalAdminInfo');</script>  
            <h3><a href="admin!personalAdminInfo">[若没有自动跳转，请点击这里]</a> </h3>
        </div>
    </center>
</body>
</html>
