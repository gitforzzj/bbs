...
<html>
    ...
    <body>
        <div id="wrap">
            <div id="Top"> 
                <div id="logo">
                    <img src="<%=request.getContextPath()%>/upload/huanong.png" alt="BBS"  border="0"  />
                    <label style="font-size:30px; font-weight: bold;">JAVA论坛</label>
                    <div id="logRegist">
                        ...
                        <s:elseif test="#session.admin!=null">    
                            <span id="po"><img style="float: right;width:50px; height:50px;" src="<%=request.getContextPath()%>/upload/<s:property value="#session.admin.photoPath" />" /></span>
                            <h4><a href="admin!personalAdminInfo.action"><s:property value="#session.admin.nickName" /> </a></h4>
                        </s:elseif>  
                        <s:else>    
                    ...
                    <ul id="menu_left">
                       ...
                       <s:if test="#session.student!=null">
                        ...
                        <li id="m_07"><a href="board!loadRootBoards.action">版块管理</a></li>
                          <li class="menu_ge"></li>
                          <li id="m_07"><a href="admin!showUser.action">用户管理</a></li>
                          <li class="menu_ge"></li>
                          <li id="m_08"><a href="login!exit.action">退出</a></li>
                        <%}%>
